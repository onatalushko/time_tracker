...
/**
 * @file
 * Contains \Drupal\time_tracker\Controller\AdminController.
 */
...
class AdminController extends ControllerBase {
  ...
  public function adminPage(Request $request, $type = 'new') {
    if ($request->request->get('operation') == 'delete' && $request->request->get('time_entries')) {
      return $this->formBuilder->getForm('\Drupal\time_tracker\Form\ConfirmDeleteMultiple', $request);
    }
    else {
      return $this->formBuilder->getForm('\Drupal\time_tracker\Form\CommentAdminOverview', $type);
    }
  }
